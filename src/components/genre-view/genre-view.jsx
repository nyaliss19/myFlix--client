    ...
    return (
      <div className='genre-view'>
        ...
        <div className='genre-view__info'>
          ...
          <span className='genre-view__info__description'>
            {genre.Description}
          </span>
          <p className='genre-view__info__movie-list-label'>
            Some movies that belong to this genre
          </p>
